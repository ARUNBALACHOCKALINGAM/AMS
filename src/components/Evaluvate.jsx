...
function Evaluvate() {
  ...
  return (
    <>
       ...
       <h4>{element.AssignmentName}<VisibilityIcon  style={{width:"40px",height:"40px",backgroundColor:"black",borderRadius:"50%",marginLeft:"300px",color:"white",padding:"10px"}}/></h4>
     </Card>
     )
     })}
